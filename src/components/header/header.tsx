...
import { FaGhost, FaList, FaStudiovinari } from "react-icons/fa";
          ...
          <div className="hidden lg:block">
            <div className="flex">
              <Link href={"/contact_us"}>
                <button className="inline-flex h-12 animate-shimmer items-center justify-center  border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%]  font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50 rounded-3xl py-2 px-5 text-white">
                  Notify Me
                </button>
              </Link>
            </div>
